...
#
# Generated Thu Sep 15 14:21:39 2011 by generateDS.py version 2.6a.
#
...
class expression(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='expression'):
        if self.type_ is not None and 'type_' not in already_processed:
            ...
            outfile.write(' xsi:type=%s' % (self.gds_format_string(quote_attrib(self.type_).encode(ExternalEncoding), input_name='type'), ))
...
class expr(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, type_=None, op=None, expression=None):
        self.type_ = _cast(None, type_)
...
def parse(inFileName):
    ...
    rootObj.export(sys.stdout, 0, name_=rootTag, 
        namespacedef_='xmlns:saw="com.siebel.analytics.web/report/v1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sawx="com.siebel.analytics.web/expression/v1"')
    return rootObj
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="expression",
        namespacedef_='xmlns:saw="com.siebel.analytics.web/report/v1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sawx="com.siebel.analytics.web/expression/v1"')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from filterElement import *\n\n')
    sys.stdout.write('import filterElement as model_\n\n')
